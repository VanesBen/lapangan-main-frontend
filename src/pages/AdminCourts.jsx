...
export default function AdminCourts() {
  ...
  const loadCourts = (page = 1, search = searchQuery, cat = category, sort = sortBy) => {
    ...
    axiosClient
      ...
      .catch((err) => {
        console.error('Gagal mengambil data lapangan admin:', err);
        setCourts([]);
      })
      .finally(() => {
        setIsLoading(false);
  ...
  // Debounce input pencarian dan refetch saat filter berubah
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#1c1d1f] text-white flex flex-col font-sans">
      ...
      {/* 2. HERO SECTION DENGAN FLOATING SEARCH BAR & DROPDOWNS */}
        ...
        <div className="max-w-5xl mx-auto px-4 -mt-7 md:-mt-8 relative z-10">
          <div className="flex flex-col md:flex-row items-stretch gap-3 shadow-2xl">
            ...
            <div className="relative flex-1 flex items-center rounded-sm overflow-hidden bg-[#d9d9d9]">
              ...
              <input
                type="text"
                placeholder="Cari Lapangan Saya..."
                value={searchQuery}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Daftar seluruh lapangan milik Anda yang terdaftar di sistem.
            </p>
          </div>
